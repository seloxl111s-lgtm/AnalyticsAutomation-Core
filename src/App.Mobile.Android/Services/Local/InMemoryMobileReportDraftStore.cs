    ...
    global::App.Mobile.Android.Services.Abstractions.IMobileReportDraftStore
{
    ...
    public Task<global::App.Mobile.Android.Reports.MobileReportDraft?> AttachSelectedVideoAsync(
        string draftId,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        lock (_gate)
        {
            ...
            if (index < 0)
            {
                return Task.FromResult<global::App.Mobile.Android.Reports.MobileReportDraft?>(null);
            }
            ...
            return Task.FromResult<global::App.Mobile.Android.Reports.MobileReportDraft?>(updatedDraft);
        }
    }
}
